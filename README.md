...
I would like to optimise the image styles to be even more responsive and more finely tuned to each page. I would know how to optimise images for future use to ensure the performace score by Lighthouse was even higher rated.

## Technologies Used
**GitHub** - Stored the main project with ability to deploy online
**GitPod** - the software used to build the HTML code and create CSS styles
**HTML5** - The current version of HTML used 
**CSS** - The style language used 
**Font Awesome** - Icon source page
...
- Fontawesome - for icon sources for social network sites and more
